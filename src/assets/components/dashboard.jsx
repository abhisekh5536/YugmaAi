...
const Dashboard = () => {
  ...
  // Fix: Correct filtering with proper parentheses
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-black text-white pt-24 pb-16 px-4 sm:px-6">
      <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8 bg-gray-800/50 backdrop-blur-lg rounded-xl p-6 border border-gray-700 shadow-xl">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              ...
              <button
                ...
                className="flex items-center gap-2 text-red-400 hover:text-red-300 transition-colors px-4 py-2 rounded-lg border border-red-400/30 hover:bg-red-400/10 whitespace-nowrap"
              >
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400 mt-3 text-sm sm:text-base max-w-3xl">
            View and manage all your previous AI-generated projects
          </p>
        </div>

        {/* Search and New Project */}
        <div className="mb-6 bg-gray-800/50 backdrop-blur-lg rounded-xl p-4 sm:p-6 border border-gray-700 shadow-xl">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <button
              className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-5 py-2 rounded-lg font-medium flex items-center gap-2 transition-all duration-200 transform hover:scale-105 shadow-lg shadow-blue-500/20 whitespace-nowrap"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {filteredProjects.map((project) => (
              <div
                ...
                className="bg-gray-800/50 backdrop-blur-lg rounded-xl border border-gray-700 shadow-xl overflow-hidden transition-all duration-300 hover:border-gray-600 hover:shadow-blue-500/20 hover:-translate-y-1 cursor-pointer"
                onClick={() => handleOpenProject(project)}
              >
                <div className="p-5">
                  <div className="flex justify-between items-start mb-3">
                    <h3 className="text-lg font-semibold text-white truncate">{project.name}</h3>
                    <span className="text-xs text-gray-400 bg-gray-700 px-2 py-1 rounded-full min-w-[80px] text-center">
          ...
          <div className="bg-gray-800/50 backdrop-blur-lg rounded-xl border border-gray-700 shadow-xl p-8 text-center">
            ...
            <p className="text-gray-500 max-w-md mx-auto">
              {searchTerm
                ...
                : "You haven't created any projects yet. Start by generating a new project."}
            </p>
            {!searchTerm && (
              <button
                className="mt-4 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-6 py-2 rounded-lg font-medium transition-all duration-200 transform hover:scale-105 shadow-lg shadow-blue-500/20"
                onClick={() => navigate('/builder', { state: { prompt: '' } })}
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
              ...
              <div className="bg-gray-900/60 rounded-lg p-4 border border-gray-700 text-center">
                ...
                <p className="text-2xl font-bold text-white">
                  {formatDate(projects[0].createdAt)}
                </p>
              </div>
              <div className="bg-gray-900/60 rounded-lg p-4 border border-gray-700 text-center">
